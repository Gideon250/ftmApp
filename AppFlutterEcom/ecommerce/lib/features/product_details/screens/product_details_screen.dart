...
import 'package:mecommerce/features/product_details/services/product_details_services.dart';
          ...
          children: [
                ...
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      ...
                      style: const TextStyle(
                        fontSize: 22,
                        color: Color.fromARGB(255, 228, 109, 11),
                        fontWeight: FontWeight.w500,
                      ),
                    ),
                  ],
            ...
            Padding(
              ...
              child: CustomButton(
                text: 'Add to Cart',
                onTap: addToCart,
                color: Color.fromARGB(255, 237, 109, 4),
              ),
            ),
            const SizedBox(height: 10),
            Container(
