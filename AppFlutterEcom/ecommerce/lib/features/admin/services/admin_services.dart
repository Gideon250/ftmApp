...
class AdminServices {
  void sellProduct({
    ...
    try {
      final cloudinary = CloudinaryPublic('gigi-250', 'itwummdq');
    ...
    try {
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            Sales('Exotic', response['ExoticEarnings']),
            Sales('Vegets', response['VegetsEarnings']),
            Sales('Tomato', response['TomatoEarnings']),
            Sales('Tropical', response['TropicalEarnings']),
            Sales('Leafgreen', response['LeafgreenEarnings']),
          ];
        },
      );
    } catch (e) {
