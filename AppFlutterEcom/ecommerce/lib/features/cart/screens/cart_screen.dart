...
import 'package:mecommerce/features/cart/widget/cart_product.dart';
import 'package:mecommerce/features/cart/widget/cart_subtotal.dart';
import 'package:mecommerce/features/home/widgets/address_box.dart';
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: CustomButton(
                text: 'Continue to Buy (${user.cart.length} items)',
                onTap: () => navigateToAddress(sum),
                color:const Color.fromARGB(255, 245, 133, 35),
              ),
            ),
